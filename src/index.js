...
class WeArtCongitoPlugin {
    ...
    afterInitialize() {
        ...
        const clientName = `${this.rcsPrefix}-users-client`
        const userPoolClient = new Resource(buildUserPoolClient(clientName, google, apple, userPool.ref, this.loginCallbackUrl, this.logoutCallbackUrl));
        ...
        if (this.loginCallbackUrlMobile) {
            const clientNameMobile = `${this.rcsPrefix}-users-client-mobile`
            const userPoolClientMobile = new Resource(buildUserPoolClient(clientNameMobile, google, apple, userPool.ref, this.loginCallbackUrlMobile, this.logoutCallbackUrl, "CognitoUserPoolClientMobile"));
