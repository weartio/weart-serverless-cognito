...
class TestEmailPreSignUp(ExtendedTestCase):
    ...
    def test_pre_signup_email_with_valid_parameters(self, verify_recaptcha):
        context = None
    ...
    @mock.patch.dict(os.environ, {"PLATFORM_ALLOWED_SCOPE": "email", "USER_GROUPS_ALLOWED": "PROFESSIONAL,HOMEOWNER",
                                  "MOBILE_POOL_CLIENT_ID": MOBILE_POOL_CLIENT_ID})
    def test_pre_signup_email_with_missing_name(self, verify_recaptcha):
        context = None
    ...
    @mock.patch.dict(os.environ, {"PLATFORM_ALLOWED_SCOPE": "email", "USER_GROUPS_ALLOWED": "PROFESSIONAL,HOMEOWNER",
                                  "MOBILE_POOL_CLIENT_ID": MOBILE_POOL_CLIENT_ID})
    def test_pre_signup_email_with_missing_user_group(self, verify_recaptcha):
        context = None
    ...
    @mock.patch.dict(os.environ, {"PLATFORM_ALLOWED_SCOPE": "email", "USER_GROUPS_ALLOWED": "PROFESSIONAL,HOMEOWNER",
                                  "MOBILE_POOL_CLIENT_ID": MOBILE_POOL_CLIENT_ID})
    def test_pre_signup_email_with_invalid_user_group(self, verify_recaptcha):
        context = None
    ...
    @mock.patch.dict(os.environ, {"PLATFORM_ALLOWED_SCOPE": "email", "USER_GROUPS_ALLOWED": "PROFESSIONAL,HOMEOWNER",
                                  "MOBILE_POOL_CLIENT_ID": MOBILE_POOL_CLIENT_ID})
    def test_pre_signup_email_with_empty_parameters(self, verify_recaptcha):
        context = None
        event = None
    ...
    @mock.patch.dict(os.environ, {"PLATFORM_ALLOWED_SCOPE": "phone_number",
                                  "USER_GROUPS_ALLOWED": "PROFESSIONAL,HOMEOWNER",
                                  "MOBILE_POOL_CLIENT_ID": MOBILE_POOL_CLIENT_ID})
    def test_pre_signup_email_with_wrong_environment_variable(self, verify_recaptcha):
        context = None
        with open(get_mock_file("pre_signup", "valid_event_email")) as json_file:
            event = json.load(json_file)
